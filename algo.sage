...
def list_of_system_gen_mat_zimm(M,list_of_ranks):
    ...
    for i in xrange(-num_over_is,0) :
      ...
      c = 0
      while A.rfrom sage.combinat.gray_codes import combinations
import time 
...
def test_lent_gf2():
  ...
  for x in L :
    ...
    print ("-------------------")
        ...
        if A.rafrom sage.combinat.gray_codes import combinations
import time 
...
mns(I + [c]).rank():
          A = Mfrom sage.combinat.gray_codes import combinations
import time 
...
[c])
          I += from sage.combinat.gray_codes import combinations
import time 
...
def test_lent_gf2():
  ...
  for x in L :
    ...
    print ("-------------------")
        ...
        c += 1
        if c ==from sage.combinat.gray_codes import combinations
import time 
...
def test_lent_gf2():
  ...
  for x in L :
    ...
    print ("-------------------")
          ...
          breakfrom sage.combinat.gray_codes import combinations
import time 
